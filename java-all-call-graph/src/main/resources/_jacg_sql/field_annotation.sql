CREATE TABLE IF NOT EXISTS jacg_field_annotation{appName} (
  ...
  INDEX idx_fa_1{appName}(simple_class_name(255), field_name, annotation_name),
  INDEX idx_fa_aaa{appName}(annotation_name, attribute_name, attribute_value(255))
