CREATE TABLE IF NOT EXISTS jacg_set_method{appName} (
  ...
  INDEX idx_sm_cm{appName}(simple_class_name(255), method_name),
  INDEX idx_sm_cf{appName}(simple_class_name(255), field_name),
  INDEX idx_sm_sft{appName}(simple_field_type_nad),
  INDEX idx_sm_mh{appName}(method_hash)
