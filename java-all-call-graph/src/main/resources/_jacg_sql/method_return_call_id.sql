CREATE TABLE IF NOT EXISTS jacg_method_return_call_id{appName} (
  ...
  INDEX idx_mrci_mhrci{appName}(method_hash, return_call_id),
  INDEX idx_mrci_rci{appName}(return_call_id)
