CREATE TABLE IF NOT EXISTS jacg_class_info{appName} (
  ...
  INDEX idx_ci_scn{appName}(simple_class_name(255)),
  INDEX idx_ci_cn{appName}(class_name(255)),
  INDEX idx_ci_pnpl{appName}(package_name, package_level),
  INDEX idx_ci_jn{appName}(jar_num)
