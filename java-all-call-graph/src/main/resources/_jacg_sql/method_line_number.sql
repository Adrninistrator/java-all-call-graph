CREATE TABLE IF NOT EXISTS jacg_method_line_number{appName} (
  ...
  INDEX idx_mln_mh{appName}(method_hash),
  INDEX idx_mln_scl{appName}(simple_class_name(255), min_line_number, max_line_number),
  INDEX idx_mln_scm{appName}(simple_class_name(255), method_name)
