CREATE TABLE IF NOT EXISTS jacg_method_throw{appName} (
  ...
  INDEX idx_mt_mhcso{appName}(method_hash, catch_start_offset),
  INDEX idx_mt_mhci{appName}(method_hash, call_id),
  INDEX idx_mt_ci{appName}(call_id),
  INDEX idx_mt_scn{appName}(simple_class_name(255))
