CREATE TABLE if not exists jacg_method_return_field_info_{appName} (
  ...
  field_simple_type varchar(255) NOT NULL COMMENT '方法返回的字段类型唯一类名',
