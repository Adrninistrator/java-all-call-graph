CREATE TABLE IF NOT EXISTS jacg_mybatis_ms_select_column{appName} (
  ...
  INDEX idx_mmselc_mscm{appName}(mapper_simple_class_name(255), mapper_method_name),
  INDEX idx_mmselc_tncn{appName}(table_name, column_name),
  INDEX idx_mmselc_xfn{appName}(xml_file_name)
