CREATE TABLE IF NOT EXISTS jacg_method_arg_generics_type{appName} (
  ...
  INDEX idx_magt_matt{appName}(method_hash, seq, type, type_seq),
  INDEX idx_magt_scn{appName}(simple_class_name(255)),
  INDEX idx_magt_sgt{appName}(simple_generics_type_nad)
