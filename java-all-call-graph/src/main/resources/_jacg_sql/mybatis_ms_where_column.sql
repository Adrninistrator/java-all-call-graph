CREATE TABLE IF NOT EXISTS jacg_mybatis_ms_where_column{appName} (
  ...
  INDEX idx_mmwc_mscm{appName}(mapper_simple_class_name(255), mapper_method_name),
  INDEX idx_mmwc_tncn{appName}(table_name, column_name),
  INDEX idx_mmwc_xfn{appName}(xml_file_name)
