CREATE TABLE IF NOT EXISTS jacg_method_catch{appName} (
  ...
  INDEX idx_mcth_mh{appName}(method_hash),
  INDEX idx_mcth_scn{appName}(simple_class_name(255)),
  INDEX idx_mcth_sct{appName}(simple_catch_exception_type)
