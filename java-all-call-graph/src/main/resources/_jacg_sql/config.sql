CREATE TABLE IF NOT EXISTS jacg_config{appName} (
  ...
  PRIMARY KEY (config_file_name, config_key, config_value(255))
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='java-callgraph2与当前组件使用的配置参数表';