CREATE TABLE IF NOT EXISTS jacg_package_info{appName} (
  ...
  UNIQUE INDEX uni_pi_pnjn{appName}(package_name, jar_num),
  INDEX idx_pi_plpn{appName}(package_level, package_name)
