CREATE TABLE IF NOT EXISTS jacg_enum_init_assign_info{appName} (
  ...
  class_name varchar(300) NOT NULL COMMENT '枚举完整类名',
  full_method text NOT NULL COMMENT '枚举类构造函数完整方法（类名+方法名+参数）',
  PRIMARY KEY (record_id),
  INDEX idx_eiai_scnas{appName}(simple_class_name(255), arg_seq)
