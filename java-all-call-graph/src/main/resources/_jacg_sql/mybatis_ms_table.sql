CREATE TABLE IF NOT EXISTS jacg_mybatis_ms_table{appName} (
  ...
  INDEX idx_mmt_scm{appName}(mapper_simple_class_name(255), mapper_method_name, sql_statement, table_seq),
  INDEX idx_mmt_xfn{appName}(xml_file_name)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='MyBatis Mapper方法操作的数据库表信息（使用MySQL）';