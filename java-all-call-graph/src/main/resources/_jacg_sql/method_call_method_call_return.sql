CREATE TABLE IF NOT EXISTS jacg_method_call_method_call_return{appName} (
  ...
  INDEX idx_mcmcr_eemh{appName}(callee_method_hash),
  INDEX idx_mcmcr_eecm{appName}(callee_simple_class_name(255), callee_method_name)
