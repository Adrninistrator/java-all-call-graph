CREATE TABLE IF NOT EXISTS jacg_class_name{appName} (
  ...
  INDEX idx_cn_cn{appName}(class_name(255)),
  INDEX idx_cn_scn{appName}(simple_class_name(255)),
  INDEX idx_cn_dc{appName}(duplicate_class)
