CREATE TABLE IF NOT EXISTS jacg_mybatis_ms_get_set_db{appName} (
  ...
  INDEX idx_mmgsd{appName}(fld_relationship_id),
  INDEX idx_gmci{appName}(get_method_call_id),
  INDEX idx_smci{appName}(set_method_call_id)
