CREATE TABLE IF NOT EXISTS jacg_class_ext_impl_generics_type{appName} (
  ...
  super_itf_simple_class_name varchar(300) NOT NULL COMMENT '父类或接口的唯一类名',
  ...
  super_itf_class_name varchar(300) NOT NULL COMMENT '父类或接口的类名',
  PRIMARY KEY (record_id),
  INDEX idx_ceigt_scn{appName}(simple_class_name(255)),
  INDEX idx_ceigt_siscn{appName}(super_itf_simple_class_name(255))
