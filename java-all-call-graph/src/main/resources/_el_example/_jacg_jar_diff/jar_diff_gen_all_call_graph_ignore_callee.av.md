...
在 对JarDiff找到发生变化的方法生成向上/向下完整方法调用链 使用的配置参数
...
# 2. class_name - JarDiff生成向上完整方法调用链判断发生变化的方法类名
...
通过JarDiff生成向上完整方法调用链时，判断发生变化的方法类名是否等于指定关键字，忽略匹配的方法
...
# 3. package_name - JarDiff生成向上完整方法调用链判断发生变化的方法包名
...
通过JarDiff生成向上完整方法调用链时，判断发生变化的方法包名是否等于指定关键字，忽略匹配的方法
...
# 4. simple_class_name - JarDiff生成向上完整方法调用链判断发生变化的方法简单类名
...
通过JarDiff生成向上完整方法调用链时，判断发生变化的方法简单类名是否等于指定关键字，忽略匹配的方法
...
# 5. method_name - JarDiff生成向上完整方法调用链判断发生变化的方法名
...
通过JarDiff生成向上完整方法调用链时，判断发生变化的方法名是否等于指定关键字，忽略匹配的方法
...
# 6. method_arg_num - JarDiff生成向上完整方法调用链判断发生变化的方法参数数量
...
通过JarDiff生成向上完整方法调用链时，判断发生变化的方法参数数量是否等于指定值，忽略匹配的方法
...
# 7. full_method - JarDiff生成向上完整方法调用链判断发生变化的完整方法
...
通过JarDiff生成向上完整方法调用链时，判断发生变化的完整方法是否等于指定关键字，忽略匹配的方法
