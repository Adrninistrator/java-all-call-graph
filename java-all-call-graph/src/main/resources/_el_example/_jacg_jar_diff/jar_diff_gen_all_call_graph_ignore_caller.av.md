...
## 2.1. JarDiff生成向下方法完整调用链判断发生变化的方法类名
...
## 3.1. JarDiff生成向下方法完整调用链判断发生变化的方法包名
...
## 4.1. JarDiff生成向下方法完整调用链判断发生变化的方法简单类名
...
## 5.1. JarDiff生成向下方法完整调用链判断发生变化的方法名
...
## 6.1. JarDiff生成向下方法完整调用链判断发生变化的方法参数数量
...
## 7.1. JarDiff生成向下方法完整调用链判断发生变化的完整方法
