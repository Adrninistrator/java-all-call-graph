CREATE TABLE if not exists method_call_{appName} (
  ...
  caller_method_name text NOT NULL COMMENT '调用方，方法名',
  caller_full_class_name text NOT NULL COMMENT '调用方，类名全名',
  ...
  callee_method_name text NOT NULL COMMENT '被调用方，方法名',
  callee_full_class_name text NOT NULL COMMENT '被调用方，类名全名',
