...
public enum OtherConfigFileUseSetEnum implements OtherConfigInterface {
    ...
    OCFUSE_CALLER_GRAPH_CALLEE_ARG_TYPE_POLYMORPHISM(InputDirEnum.IDE_GEN_ALL_CALL_GRAPH.getDirName() + "/caller_graph_callee_arg_type_polymorphism.properties",
            ...
            , null),
    OCFUSE_BUSINESS_DATA_TYPE_SHOW_4EE(InputDirEnum.IDE_BUSINESS_DATA_TYPE.getDirName() + "/business_data_type_show_4ee.properties",
            ...
            , null),
    OCFUSE_BUSINESS_DATA_TYPE_SHOW_4ER(InputDirEnum.IDE_BUSINESS_DATA_TYPE.getDirName() + "/business_data_type_show_4er.properties",
