package com.adrninistrator.jacg.extensions.common.enums;

/**
 * @author adrninistrator
 * @date 2023/3/21
 * @description: 业务功能数据类型枚举
 */
public enum BusinessDataTypeEnum {
    ...
    BusinessDataTypeEnum(String type, String desc, boolean supportEe, boolean supportEr) {
        this.type = type;
        this.desc = desc;
    ...
    public static BusinessDataTypeEnum getFromType(String type) {
        for (BusinessDataTypeEnum businessDataTypeEnum : BusinessDataTypeEnum.values()) {
