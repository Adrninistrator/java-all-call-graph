...
public enum SqlKeyEnum {
    ...
    MC_QUERY_CALLER_METHOD_BY_NAME,
    MC_QUERY_BY_ER_HASH_EE_CLASSES_METHOD,
    MC_QUERY_NORMAL_MC_BY_PAGE_CALL_ID,
    MC_QUERY_METHOD_CALL_IN_CALLER_BY_CALLEE,
    MC_QUERY_BY_CALL_TYPE,
    MC_QUERY_CALLERS_BY_CLASS_METHOD,
    MC_QUERY_CALLEES_BY_CLASS_METHOD,
    MC_QUERY_TOP_CALLEE_METHODS,
    MC_QUERY_TOP_CALLER_METHODS,
    MC_COUNT_CALLERS_BY_CLASS_METHOD,
    MC_COUNT_CALLEES_BY_CLASS_METHOD,
    MC_UPDATE_METHOD_CALL,
    MC_UPDATE_ENABLED,
    MC_UPDATE_FLAGS,
    MCRC_QUERY,
    ...
    MCI_QUERY_ARRAY_ELEMENT_INFO,
    MCI_QUERY_ARRAY_ELEMENT_INFO_4_TYPES,
    MCSF_QUERY_BY_CLASS,
    ...
    MT_CHECK_METHOD_CALL_IS_THROW,
    PC_QUERY_ALL_BY_FILE,
    PC_QUERY_ALL_BY_KEY,
    PC_QUERY_ALL_BY_KEY_LIKE,
    PC_QUERY_MAX_RECORD_ID,
    PC_QUERY_VALUE_BY_KEY,
    XC_QUERY_BY_ELEMENT_ATTRIBUTE,
    XC_QUERY_CHILDREN_BY_ELEMENT_SEQ,
    XC_CHECK_ATTRIBUTE_EXISTS,
    XC_QUERY_ATTRIBUTE_VALUE,
    PCD_DELETE_BY_TYPE,
    PCD_QUERY_BY_TYPE,
