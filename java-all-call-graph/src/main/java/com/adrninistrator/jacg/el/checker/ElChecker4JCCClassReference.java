 ...
 * @description:
 */
public class ElChecker4JCCClassReference extends JACGElChecker {

    @Override
    protected void jacgDoCheck(ElManager elManager, ElConfigEnum elConfig) {
        elManager.checkIgnoreJCCClassReference(JavaCG2ElChecker4ParseClass.CLASS_NAME_EXAMPLE,
                JavaCG2ElChecker4ParseClass.CLASS_NAME_EXAMPLE);
    }
}
