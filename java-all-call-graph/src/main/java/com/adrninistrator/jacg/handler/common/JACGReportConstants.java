package com.adrninistrator.jacg.handler.common;
...
public class JACGReportConstants {
    ...
    public static final String COLUMN_LINE_NUMBER = "代码行号";
    ...
    public static final String COLUMN_LINE_NUMBER_IN_STACK_FILE = "在调用堆栈文件中的行号";
