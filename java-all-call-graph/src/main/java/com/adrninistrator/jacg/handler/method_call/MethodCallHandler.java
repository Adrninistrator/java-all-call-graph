package com.adrninistrator.jacg.handler.method_call;
...
public class MethodCallHandler extends BaseHandler {
    ...
    public MethodCallHandler(DbOperator dbOperator, DbOperWrapper dbOperWrapper) {
    ...
    private boolean updateMethodCallEnabled(int methodCallId, int enabled) {
        ...
        try {
            ...
            if (sql == null) {
                sql = "update " + DbTableInfoEnum.DTIE_METHOD_CALL.getTableName(dbOperWrapper.getAppName()) +
                        " set " + DC.MC_ENABLED + " = ?" +
                        " where " + DC.MC_CALL_ID + " = ?";
    ...
    public boolean manualAddMethodCall(String callerFullMethod, String calleeFullMethod) {
        ...
        String sql = dbOperWrapper.genAndCacheInsertSql(DbTableInfoEnum.DTIE_METHOD_CALL.getSqlKey(),
                ...
                DbTableInfoEnum.DTIE_METHOD_CALL.getTableName(dbOperWrapper.getAppName()),
