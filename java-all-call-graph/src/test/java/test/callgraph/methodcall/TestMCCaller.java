...
import test.callgraph.extend.I2_1_1;
...
public class TestMCCaller {
    ...
    public String test1h(String aaa) {
        TestMCCallee.test1(aaa);
        return TestMCCallee.test3(null, null, null);
    }

    public String test2a() {
        testMCCallee.test2("aa1", "aa2");
        String str1 = TestMCCallee.test3(null, null, null);
        return str1;
    }
