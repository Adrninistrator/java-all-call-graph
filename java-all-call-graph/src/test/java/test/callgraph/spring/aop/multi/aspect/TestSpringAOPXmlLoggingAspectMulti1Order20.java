...
public class TestSpringAOPXmlLoggingAspectMulti1Order20 {
    private static final Logger logger = LoggerFactory.getLogger(TestSpringAOPXmlLoggingAspectMulti1Order20.class);
