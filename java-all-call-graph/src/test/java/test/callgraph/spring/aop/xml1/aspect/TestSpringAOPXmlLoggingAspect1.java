package test.callgraph.spring.aop.xml1.aspect;
...
public class TestSpringAOPXmlLoggingAspect1 {
    private static final Logger logger = LoggerFactory.getLogger(TestSpringAOPXmlLoggingAspect1.class);
