...
public class TestMethodCallAdd extends TestMCABase {
    ...
    public void test0WithOutExtensions() {
        ...
        // 指定扩展类为空
        configureWrapperCopy.clearOtherConfigList(OtherConfigFileUseListEnum.OCFULE_EXTENSIONS_CODE_PARSER);
    ...
    public void test1WithExtensions() {
        ...
        // 指定扩展类
        configureWrapperCopy.setOtherConfigList(OtherConfigFileUseListEnum.OCFULE_EXTENSIONS_METHOD_CALL_ADD, Arrays.asList(
