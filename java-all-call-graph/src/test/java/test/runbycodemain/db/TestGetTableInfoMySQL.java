 ...
 * @date 2026/6/14
 * @description: 测试 DbOperWrapper 获取表名及COMMENT、建表语句、表字段信息功能（MySQL数据库）
 */
@RunWith(JUnit4ClassRunnerSortMethod.class)
@JACGExample(title = "获取数据库表名及COMMENT、建表语句、表字段信息（MySQL数据库）",
        desc = {})
public class TestGetTableInfoMySQL {
