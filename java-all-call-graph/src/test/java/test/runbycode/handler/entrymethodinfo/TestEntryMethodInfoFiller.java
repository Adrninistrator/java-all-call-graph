...
public class TestEntryMethodInfoFiller extends TestRunByCodeBase {
    ...
    public void test() {
        try (EntryMethodInfoFiller4Spring entryMethodInfoFiller4Spring = new EntryMethodInfoFiller4Spring(configureWrapper, null)) {
            BaseEntryMethodInfo entryMethodInfo1 = entryMethodInfoFiller4Spring.query(TestMCCaller.class.getName() + ":test1a()");
            Assert.assertNull(entryMethodInfo1);

            BaseEntryMethodInfo entryMethodInfo2 = entryMethodInfoFiller4Spring.query(TestSpringController2.class.getName() + ":get1()");
            Assert.assertTrue(entryMethodInfo2 instanceof EntryMethodInfo4SpringController);

            BaseEntryMethodInfo entryMethodInfo3 = entryMethodInfoFiller4Spring.query(TestSpringTask.class.getName() + ":run1()");
