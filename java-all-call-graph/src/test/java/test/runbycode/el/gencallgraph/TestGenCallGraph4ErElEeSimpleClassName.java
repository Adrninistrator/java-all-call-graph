 ...
 * @description:
 */
public class TestGenCallGraph4ErElEeSimpleClassName extends TestElRunByCodeBase {
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_EE_SIMPLE_CLASS_NAME.getVariableName() + " == '" + TestElExampleCallee1.class.getSimpleName() + "'";
    }
