 ...
 * @description:
 */
public class TestGenCallGraph4ErElEeMethodName extends TestElRunByCodeBase {
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_EE_METHOD_NAME.getVariableName() + " == 'testA'";
    }

    @Override
    protected String chooseTitle() {
        return "生成向下完整方法调用链判断被调用方法名";
    }

    @Override
    protected String chooseDesc() {
        return "在生成向下完整方法调用链时，判断被调用方法名是否等于指定值，忽略匹配的方法调用";
    }
