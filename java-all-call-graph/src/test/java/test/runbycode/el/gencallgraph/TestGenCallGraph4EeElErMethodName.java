 ...
 * @description:
 */
public class TestGenCallGraph4EeElErMethodName extends TestElRunByCodeBase {
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_ER_METHOD_NAME.getVariableName() + " == 'test1'";
    }

    @Override
    protected String chooseTitle() {
        return "生成向上方法完整调用链判断调用方法名";
    }

    @Override
    protected String chooseDesc() {
        return "在生成向上方法完整调用链时，判断调用方法名是否等于指定值，忽略匹配的方法调用";
    }
