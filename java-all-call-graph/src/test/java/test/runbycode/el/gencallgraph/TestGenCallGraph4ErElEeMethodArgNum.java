 ...
 * @description:
 */
public class TestGenCallGraph4ErElEeMethodArgNum extends TestElRunByCodeBase {
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_EE_METHOD_ARG_NUM.getVariableName() + " == 0";
    }

    @Override
    protected String chooseTitle() {
        return "生成向下方法完整调用链判断被调用方法参数数量";
    }

    @Override
    protected String chooseDesc() {
        return "在生成向下方法完整调用链时，判断被调用方法参数数量是否等于指定值，忽略匹配的方法调用";
    }
