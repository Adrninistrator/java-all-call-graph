 ...
 * @description:
 */
public class TestGenCallGraph4ErElFlagsExcludeMultiOr extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return "include(" + ElAllowedVariableEnum.EAVE_MC_FLAGS_ENUM.getVariableName() + ", '" + MethodCallFlagsEnum.MCFE_ER_METHOD_ANNOTATION.name() + "') || " +
