 ...
 * @description:
 */
public class TestGenCallGraph4EeElErClassNameEqualsAny extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.equalsAny(" + CommonElAllowedVariableEnum.EAVE_MC_ER_CLASS_NAME.getVariableName() + ", '" + TestElExampleCaller1.class.getName() + "', '" +
    ...
    protected String chooseDesc() {
        return "在生成向上完整方法调用链时，判断调用类名是否等于指定多个关键字之一，忽略匹配的方法调用";
    }
