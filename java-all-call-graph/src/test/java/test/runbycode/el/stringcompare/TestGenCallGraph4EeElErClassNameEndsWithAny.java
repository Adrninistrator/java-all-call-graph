 ...
 * @description:
 */
public class TestGenCallGraph4EeElErClassNameEndsWithAny extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return "string.endsWithAny(" + CommonElAllowedVariableEnum.EAVE_MC_ER_CLASS_NAME.getVariableName() + ", '" + TestElExampleCaller1.class.getName() + "', '" +
    ...
    protected String chooseDesc() {
        return "在生成向上方法完整调用链时，判断调用类名是否以指定多个关键字之一结尾，忽略匹配的方法调用";
    }
