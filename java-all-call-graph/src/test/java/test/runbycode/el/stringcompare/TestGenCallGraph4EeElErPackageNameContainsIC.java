 ...
 * @description:
 */
public class TestGenCallGraph4EeElErPackageNameContainsIC extends TestElRunByCodeBase {
    ...
    protected String chooseElText() {
        return "string.containsIC(" + CommonElAllowedVariableEnum.EAVE_MC_ER_PACKAGE_NAME.getVariableName() + ", '" + TestGenCallGraph4EeElErPackageName.ER_PACKAGE_NAME_UPPER + "')";
    }
    ...
    protected String chooseDesc() {
        return "在生成向上完整方法调用链时，判断调用类包名是否包含指定关键字（忽略大小写），忽略匹配的方法调用";
    }
