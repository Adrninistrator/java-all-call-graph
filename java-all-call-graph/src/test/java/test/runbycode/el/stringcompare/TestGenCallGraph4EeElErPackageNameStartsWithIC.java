 ...
 * @description:
 */
public class TestGenCallGraph4EeElErPackageNameStartsWithIC extends TestElRunByCodeBase {
    ...
    protected String chooseElText() {
        return "string.startsWithIC(" + CommonElAllowedVariableEnum.EAVE_MC_ER_PACKAGE_NAME.getVariableName() + ", '" + TestGenCallGraph4EeElErPackageName.ER_PACKAGE_NAME_UPPER + "')";
    }

    @Override
    protected String chooseTitle() {
        return "判断以关键字开头（忽略大小写）";
    }
