 ...
 * @description:
 */
public class TestCompatibilityCheckFastEeSimpleClassName extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_EE_SIMPLE_CLASS_NAME.getVariableName() + " != '" + System.class.getSimpleName() + "'";
    }

    @Override
    protected String chooseTitle() {
        return "Jar兼容性检查快速模式判断被引用类简单类名";
    }

    @Override
    protected String chooseDesc() {
        return "Jar兼容性检查快速模式，判断被引用类简单类名是否等于指定值，仅处理匹配的类引用关系";
    }
