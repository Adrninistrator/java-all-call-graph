 ...
 * @description:
 */
public class TestCompatibilityCheckFastErClassName extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return CommonElAllowedVariableEnum.EAVE_MC_ER_CLASS_NAME.getVariableName() + " != '" + A1_1.class.getName() + "'";
    }

    @Override
    protected String chooseTitle() {
        return "Jar兼容性检查快速模式判断引用类名";
    }

    @Override
    protected String chooseDesc() {
        return "Jar兼容性检查快速模式，判断引用类名是否等于指定值，仅处理匹配的类引用关系";
    }
