 ...
 * @description:
 */
public class TestGenJarDiffCallerGraph4PackageName extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return JavaCG2ElAllowedVariableEnum.EAVE_PARSE_PACKAGE_NAME.getVariableName() + " == '" + TestConstants.PACKAGE_NAME_JAR_DIFF_TEST_CONTROLLER1 + "'";
    }

    @Override
    protected String chooseTitle() {
        return "JarDiff生成向下方法完整调用链判断发生变化的方法包名";
    }

    @Override
    protected String chooseDesc() {
        return "通过JarDiff生成向下方法完整调用链时，判断发生变化的方法包名是否等于指定关键字，忽略匹配的方法";
    }
