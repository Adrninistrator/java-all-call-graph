 ...
 * @description:
 */
public class TestGenJarDiffCalleeGraph4MethodArgNum extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseTitle() {
        return "JarDiff生成向上方法完整调用链判断发生变化的方法参数数量";
    }

    @Override
    protected String chooseDesc() {
        return "通过JarDiff生成向上方法完整调用链时，判断发生变化的方法参数数量是否等于指定值，忽略匹配的方法";
    }

    @Test
    public void test() {
        genJarDiffCallGraph(true, new String[]{
                TestConstants.CLASS_NAME_JAR_DIFF_TEST_JAR_DIFF_TABLE_MAPPER,
                TestConstants.CLASS_NAME_JAR_DIFF_TEST_CONTROLLER1 + ":post(",
        }, new String[]{
                TestConstants.CLASS_NAME_JAR_DIFF_TEST_TASK1,
                TestConstants.CLASS_NAME_JAR_DIFF_TEST_SERVICE1,
