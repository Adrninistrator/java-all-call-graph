 ...
 * @description:
 */
public class TestGenJarDiffCalleeGraph4FullMethod extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return JavaCG2ElAllowedVariableEnum.EAVE_PARSE_FULL_METHOD.getVariableName() + " == '" + TestConstants.CLASS_NAME_JAR_DIFF_TEST_CONTROLLER1 + ":get1()'";
    }

    @Override
    protected String chooseTitle() {
        return "JarDiff生成向上方法完整调用链判断发生变化的完整方法";
    }

    @Override
    protected String chooseDesc() {
        return "通过JarDiff生成向上方法完整调用链时，判断发生变化的完整方法是否等于指定关键字，忽略匹配的方法";
    }
