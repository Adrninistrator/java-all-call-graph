 ...
 * @description:
 */
public class TestGenJarDiffCalleeGraph4ClassName extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + " == '" + TestController1.class.getName() + "'";
    }

    @Override
    protected String chooseTitle() {
        return "JarDiff生成向上完整方法调用链判断发生变化的方法类名";
    }

    @Override
    protected String chooseDesc() {
        return "通过JarDiff生成向上完整方法调用链时，判断发生变化的方法类名是否等于指定关键字，忽略匹配的方法";
    }
