 ...
 * @description:
 */
public class TestSpringAopEl4SpringBeanClassName extends TestElRunByCodeBase {
    @Override
    ...
    protected String chooseElText() {
        return JavaCG2ElAllowedVariableEnum.EAVE_PARSE_CLASS_NAME.getVariableName() + " == '" + TestSpringAOPAnnoPointcutUserServiceImpl1.class.getName() + "'";
    }

    @Override
    protected String chooseTitle() {
        return "解析Spring AOP影响方法判断受影响Bean类名";
    }

    @Override
    protected String chooseDesc() {
        return "在解析Spring AOP影响方法时，判断受影响Bean类名是否等于指定关键字，忽略匹配的Bean";
    }
