...
```
testImplementation 'com.github.adrninistrator:java-all-call-graph:2.0.8'
```
...
```
https://repo1.maven.org/maven2/com/github/adrninistrator/java-all-call-graph/2.0.8/java-all-call-graph-2.0.8.pom
https://repo1.maven.org/maven2/com/github/adrninistrator/java-callgraph2/2.0.7/java-callgraph2-2.0.7.pom
```
