...
```
testImplementation 'com.github.adrninistrator:java-all-call-graph:3.1.0'
```
...
```
https://repo1.maven.org/maven2/com/github/adrninistrator/java-all-call-graph/3.1.0/java-all-call-graph-3.1.0.pom
https://repo1.maven.org/maven2/com/github/adrninistrator/java-callgraph2/3.1.0/java-callgraph2-3.1.0.pom
```
