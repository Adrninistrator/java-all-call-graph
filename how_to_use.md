...
```
testImplementation 'com.github.adrninistrator:java-all-call-graph:3.0.6'
```
...
```
https://repo1.maven.org/maven2/com/github/adrninistrator/java-all-call-graph/3.0.6/java-all-call-graph-3.0.6.pom
https://repo1.maven.org/maven2/com/github/adrninistrator/java-callgraph2/3.0.9/java-callgraph2-3.0.9.pom
```
