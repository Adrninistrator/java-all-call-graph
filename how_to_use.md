...
```
testImplementation 'com.github.adrninistrator:java-all-call-graph:2.0.2'
```
...
```
https://repo1.maven.org/maven2/com/github/adrninistrator/java-all-call-graph/2.0.2/java-all-call-graph-2.0.2.pom
https://repo1.maven.org/maven2/com/github/adrninistrator/java-callgraph2/2.0.4/java-callgraph2-2.0.4.pom
```
